...
export default async function MathIndex() {
  const sections = await prisma.section.findMany({ where: { type: "MATH" }, orderBy: [{ examId: "asc" }, { order: "asc" }], include: { exam: true } });
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-bold">Math Sections</h1>
